...
public class AddActivity extends AppCompatActivity {
    ...
    EditText ten, anh, mota, tinhtrang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tinhtrang = (EditText) findViewById(R.id.txttinhtrang);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                insertData();
                clearAll();
                startActivity(new Intent(AddActivity.this, DongVat.class));
            }
        });
    ...
    private void insertData(){
        ...
        FirebaseDatabase.getInstance().getReference().child("dongvat").push()
                .setValue(map)
