...
public class DongVatAdapter extends FirebaseRecyclerAdapter<DongVatModel, DongVatAdapter.myViewHolder> {
     ...
     * @param options
     */
    public DongVatAdapter(@NonNull FirebaseRecyclerOptions<DongVatModel> options, Context mcontext) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder,final @SuppressLint("RecyclerView") int position, @NonNull DongVatModel model) {
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.dongvat_item,parent,false);
